<template>
 <div class="small-videl-detail">
  ...
  <!-- 评论面板 -->
  <van-action-sheet v-model="show" @select="onSelectPingLun" >
  ...
  <!-- 评论框 -->
  <van-action-sheet v-model="detailShow" @select="onSelectPingLun" >
   <div class="content">
...
<script>
 ...
 data() {
  ...
  videoList: [{
   ...
   cover: require('./videos/1.mp4'),
  }, {
   url: require('./images/2.jpg'),
   cover: require('./videos/2.mp4'),

  }, {
   url: require('./images/3.jpg'),
   cover: require('./videos/3.mp4'),
  }, {
   url: require('./images/4.jpg'),
   cover: require('./videos/4.mp4'),
  }, {
   url: require('./images/5.jpg'),
   cover: require('./videos/5.mp4'),
  }, {
   url: require('./images/6.jpg'),
   cover: require('./videos/6.mp4'),
  }],
  isVideoShow: true,
  playOrPause: true,
  video: null,
